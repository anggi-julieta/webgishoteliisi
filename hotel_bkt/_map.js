        var map;
        var server = https://anggijulieta28webgishoteliisi.herokuapp.com/;
  ...
  $('#tombol').append('<a type="button" id="showlegenda" onclick="legenda()" class="btn btn-success btn-sm " data-toggle="tooltip" title="Legenda" style="margin-right: 7px;color:black;"><i class="fa fa-eye" style="color:white;"> </i></a>');
          ...
          $.ajax({url: server+'_data_hotel_cari.php?tipe='+tipe+'&nilai='+y, data: "", dataType: 'json', success: function(rows){ 
            if(rows == null)
            {
              ...
              for (var i in rows){ 
                ...
                var lng = row.lng;
                var lat = row.lat;
                $('#kanan_table').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='data_hotel_1_info(\""+id+"\")'></a><a role='button' class='btn btn-success fa fa-taxi' style='margin-left:10px;' title='Angkot' onclick='angkot_sekitar(\""+id+"\")'></a></td></tr>");  
      ...
      *********************************************************************************************************************************************************** */
      ...
      function kuliner_sekitar(latitude,longitude,rad){ //KULINER SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_culinary_place.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#table_kanan_culinary').append("<tr><td style='width:50%'>"+name+"</td><td><a role='button' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_kuliner(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function masjid_sekitar(latitude,longitude,rad){ // MASJID SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_sekitar_worship_place.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            $('#table_kanan_worship').append("<tr><td style='width:50%'>"+name+"</td><td><a role='button' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_masjid(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function oleholeh_sekitar(latitude,longitude,rad){ // OLEH-OLEH SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_souvenir.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#table_kanan_souvenir').append("<tr><td style='width:50%'>"+name+"</td><td><a role='button' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_oo(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function tw_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_tourism.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#table_kanan_tourism').append("<tr><td style='width:50%'>"+name+"</td><td><a role='button' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info'title='info' onclick='modal_tw(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
      ...
      function h_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
        ...
        $('#table_kanan_hotel').append("<tr><th class='centered'>Hotel Name</th><th class='centered' colspan='5'>Action</th></tr>"); 
          ...
          $.ajax({url: server+'_sekitar_hotel.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            ...
            $('#table_kanan_hotel').append("<tr><td style='width:50%'>"+name+"</td><td><a role='button' class='btn btn-success fa fa-road'title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_hotel(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function restaurant_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_restaurant.php?lat='+latitude+'&lng='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#table_kanan_restaurant').append("<tr><td style='width:50%'>"+name+"</td><td><a role='button' class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_restaurant(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='angkot_sekitar_lagi(\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function angkot_sekitar(id){ // Menu Angkot - List Angkot
        ...
        $('#table_kanan_angkot').empty();
        $('#table_kanan_angkot').append("<tr><th class='centered'>Destination</th><th class='centered' colspan='3'>Action</th></tr>");
        ...
        { 
            for (var i in rows){ 
              ...
              $('#table_kanan_angkot').append("<tr><td>"+destination+"</td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_angkot(\""+ids+"\")'></a><a  role='button' class='btn btn-success fa fa-road' title='route' style='margin-left:10px;' onclick='clearangkot();route_angkot(\""+lat2+"\",\""+lng2+"\",\""+lat+"\",\""+lng+"\",\""+ids+"\",\""+id+"\")'></a></td></tr>");         
